...
.EXIT
; OBS: Por conta da dificuldade deste TP, realizamos o TP em grupo. 
; Os integrantes que participaram da resolução foram Ailton, Giovanna, Kevin, Lucas Komatsu e Manuel Cassiano